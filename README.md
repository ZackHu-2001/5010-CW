...
## Running example one (with my own defined map)
...
5: Exit
1
Currently the target locates in room 1.
...
5: Exit
1
Currently the target locates in room 2.
...
5: Exit
1
Currently the target locates in room 3.
...
5: Exit
1
Currently the target locates in room 4.
...
5: Exit
1
Currently the target locates in room 5.
...
5: Exit
1
Currently the target locates in room 6.
...
5: Exit
1
Currently the target locates in room 7.
...
5: Exit
1
Currently the target locates in room 8.
...
5: Exit
1
Currently the target locates in room 9.
...
5: Exit
1
Currently the target locates in room 10.
...
5: Exit
1
Currently the target locates in room 11.
...
5: Exit
1
Currently the target locates in room 12.
...
5: Exit
1
Currently the target locates in room 13.
...
5: Exit
1
Currently the target locates in room 14.
...
5: Exit
1
Currently the target locates in room 15.
...
5: Exit
1
Currently the target locates in room 16.
...
5: Exit
1
Currently the target locates in room 17.
...
5: Exit
1
Currently the target locates in room 18.
...
5: Exit
1
Currently the target locates in room 19.
...
5: Exit
1
Currently the target locates in room 20.
...
5: Exit
1
Currently the target locates in room 21.
...
5: Exit
1
Currently the target locates in room 22.
...
5: Exit
1
Currently the target locates in room 23.
...
5: Exit
1
Currently the target locates in room 24.
...
5: Exit
1
Currently the target locates in room 0.
...
## Running example two (with my own defined map)
(base) zackhu@ZackHudeMacBook-Pro KillDoctorLucky % java -jar out/artifacts/KillDoctorLucky_jar/KillDoctorLucky.jar res/myMansion.txt
Successfully read in the file!
...
## Running example three (with my own defined map)
(base) zackhu@ZackHudeMacBook-Pro KillDoctorLucky % java -jar out/artifacts/KillDoctorLucky_jar/KillDoctorLucky.jar res/myMansion.txt
Successfully read in the file!
...
3
4       
Room 4 [Right Eyebrow Two]: 1 17, 4 20
Items within: [Letter Opener]: 2, in 4# room;
Neighbors: Right Eyebrow One, Right Eyebrow Three,
...
5: Exit
3 5
Room 5 [Right Eyebrow Three]: 0 21, 3 24
Items within:
Neighbors: Right Eyebrow Two,
...
## Running example four (with my own defined map)
(base) zackhu@ZackHudeMacBook-Pro KillDoctorLucky % java -jar out/artifacts/KillDoctorLucky_jar/KillDoctorLucky.jar res/myMansion.txt
Successfully read in the file!
...
5: Exit
4 3
Visible Room of Room 3:
[Right Eyebrow Two]: 1 17, 4 20
Items within: [Letter Opener]: 2, in 4# room;
Neighbors: Right Eyebrow One, Right Eyebrow Three,
...
5: Exit
4 18
Visible Room of Room 18:
[FOO Right]: 8 17, 9 24
Items within: [Crepe Pan]: 3, in 8# room; [Sharp Knife]: 3, in 8# room;
Neighbors: Fore Head, Cheek Right One,


        [Cheek Right]: 16 14, 17 19
                Items within: [Rat Poison]: 2, in 19# room; [Piece of Rope]: 2, in 19# room; 
                Neighbors: Cheek Right One, 
...
5: Exit
4 24
Visible Room of Room 24:
[Mouse Left]: 25 5, 26 7
Items within:
Neighbors: Lip Up, Lip Down, Moustache,


        [Mouse Right]: 25 17, 26 19
                Items within: 
                Neighbors: Lip Up, Lip Down, Moustache, 
